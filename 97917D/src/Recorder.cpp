...
//Work in Progress
velocityRecordedMotor LeftF(PORT1,gearSetting::ratio18_1,false,"LeftFront.txt");
velocityRecordedMotor LeftB(PORT2,gearSetting::ratio18_1,false,"LeftBack.txt");
velocityRecordedMotor RightF(PORT3,gearSetting::ratio18_1,false,"RightFront.txt");
velocityRecordedMotor RightB(PORT4,gearSetting::ratio18_1,false,"RightBack.txt");
velocityRecordedMotor Elev(PORT8,gearSetting::ratio36_1,true,"Elevator.txt");
velocityRecordedMotor SwingL(PORT5,gearSetting::ratio36_1,false,"SwingLeft.txt");
velocityRecordedMotor SwingR(PORT6,gearSetting::ratio36_1,true,"SwingRight.txt");
velocityRecordedMotor Arm(PORT7,gearSetting::ratio36_1,true,"ArmMotor.txt");
