...
vex::motor SwingLeft = vex::motor(vex::PORT11,vex::gearSetting::ratio36_1,true);
vex::motor SwingRight = vex::motor(vex::PORT20,vex::gearSetting::ratio36_1,false);
vex::motor ArmMotor = vex::motor(vex::PORT6,vex::gearSetting::ratio36_1,false);
vex::brain::sdcard sd;
